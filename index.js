...
async function downloadSessionData() {
    ...
    const sessdata = config.SESSION_ID.split("AI-BOT-MD&")[1];
        ...
        Matrix.ev.on('connection.update', (update) => {
            ...
            if (connection === 'close') {
                ...
                if (initialConnection) {
                    console.log(chalk.green("📍 AI-BOT-MD V1.9 CONNECTED Successful️ ✅"));
                    Matrix.sendMessage(Matrix.user.id, { text: `📍AI-BOT-MD V1.9 CONNECTED Successful️ ✅` });
