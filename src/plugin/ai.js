const {
  ...
  smd({
    ...
    try {
      ...
      const { result } = res;
      const astro = "ᴀɪ-ʙᴏᴛ_MD-V1 ɢᴇᴍɪɴɪ ᴀɪ"
      const tbl = "```";
    ...
    async (_0x2acf30) => {
      try {
        if (
          ...
          if (
            _0x2acf30.reply_text.includes("ᴀɪ-ʙᴏᴛ-MD_V1• ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") &&
            _0x2dfb59[0].includes("ᴀɪ-ʙᴏᴛ-ᴍᴅ_V1 • ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") &&
            ...
            try {
              if (_0x2ecd2a) {
                ...
                if (_0x13a11c.toLowerCase().startsWith("reply")) {
                  ...
                  let _0x3f6b59 =
                    "*ᴀɪ_ʙᴏᴛ_MD-V1 • ʏᴏᴜʀ ᴀɴᴏɴʏ-ᴍsɢ ʀᴇᴘʟʏ*\n\n*_From @" +
